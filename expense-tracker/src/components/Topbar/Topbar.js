    ...
    return (
        <header className="dashboard__topbar">
            ...
            <div className="dashboard__topbar__users">
                <img src={props.avatar || Avatar} alt="user-avatar" className="dashboard__topbar__users_avatar" />
                <span className="dashboard__topbar__users_name">{props.username || 'Anonymous'}</span>
